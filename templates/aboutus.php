...
<div class="container my-5 py-5">
  <div class="row row-cols-auto gx-lg-5">
    ...
    <div class="col-12 col-md-8">
      <p class="fw-bold fs-xl-3"><?= get_the_title() ?></p>
    </div>

    <div class="col-12 col-md-4">
      <p class="m-0 pt-lg-3"><?= get_the_content() ?></p>
    </div>
  </div>
</div>
    ...
    <div class="py-3">
      <div class="row">
        <div class="col-12 col-md-4 text-center">
          <p class="fw-bold fs-xl-2 mb-2 pb-1 text-orange"><?= carbon_get_theme_option("about_us_stats_one_title") ?></p>
          <p class="m-0 fs-2"><?= carbon_get_theme_option("about_us_stats_one_value") ?></p>
        </div>

        <div class="col-12 col-md-4 text-center">
          <p class="fw-bold fs-xl-2 mb-2 pb-1 text-orange"><?= carbon_get_theme_option("about_us_stats_two_title") ?></p>
          <p class="m-0 fs-2"><?= carbon_get_theme_option("about_us_stats_two_value") ?></p>
        </div>

        <div class="col-12 col-md-4 text-center">
          <p class="fw-bold fs-xl-2 mb-2 pb-1 text-orange"><?= carbon_get_theme_option("about_us_stats_three_title") ?></p>
          <p class="m-0 fs-2"><?= carbon_get_theme_option("about_us_stats_three_value") ?></p>
        </div>
      </div>
    </div>
  </div>
...
<div class="container my-5 py-5">
  ...
  <div class="row gy-5 gx-lg-5">
    <div class="col-12 col-md-6">
      <?= carbon_get_theme_option("about_us_left_section") ?>
    </div>

    <div class="col-12 col-md-6">
      <?= carbon_get_theme_option("about_us_right_section") ?>
    </div>
  </div>
</div>
